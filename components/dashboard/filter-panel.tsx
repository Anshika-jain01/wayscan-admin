    ...
    <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-slate-400">Refine data visualization and reports</p>
          </div>
          {activeCount > 0 && (
        ...
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-slate-500 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-colors"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex h-11 bg-slate-100/50 p-1 rounded-xl border border-slate-200">
